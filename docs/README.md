# LowCor documentation

The current product is the native iOS app in [`ios/LowCor`](../ios/LowCor), built with the **LowCor** scheme in [`ios/LowCor.xcodeproj`](../ios/LowCor.xcodeproj). Start with the [repository README](../README.md) for setup, demo steps, tests, and limits.
...
- [Core visual design](design/lowcor-core/README.md): canonical design reference, mockups, and [tokens](design/lowcor-core/tokens.json). The concept and [implementation check](design/lowcor-core/implementation-check.md) describe their point in time; current source determines shipped behavior.
