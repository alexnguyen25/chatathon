...
Run the **LowCor** scheme from `ios/LowCor.xcodeproj` on iOS 26 or newer. The app starts with **Demo day · 11:55 AM**. If demo mode was turned off earlier, open **Connections** and enable **Explore a demo day**.
...
A concise presentation line: “LowCor checks a sustained heart-rate pattern, shows the observations behind it, and helps you review an optional pause that fits your day. Facts and scheduling are computed locally; on-device AI chooses the kind of calm pause.”
