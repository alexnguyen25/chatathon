# PulsePlan health education sources
...
- [Apple HealthKit: heartRateVariabilitySDNN](https://developer.apple.com/documentation/healthkit/hkquantitytypeidentifier/heartratevariabilitysdnn): the HealthKit SDNN metric is separate from ordinary heart-rate samples. PulsePlan imports it rather than deriving beat-to-beat variability from BPM values.
...
- [CDC: About Sleep](https://www.cdc.gov/sleep/about/index.html): adult recommendations are 7+ hours ages 18–60; 7–9 ages 61–64; 7–8 ages 65+. Duration alone does not establish sleep quality. PulsePlan's displayed Health records may be incomplete.
